...
# ===== 路径配置 =====
# 这里默认你前一个脚本已经生成了这个文件
SRC_JSON_PATH = os.path.join("data", "captioning_dataset_4imgs.json")

# 输出的 train / test 文件
TRAIN_JSON_PATH = os.path.join("data", "captioning_dataset_4imgs_train_60.json")
TEST_JSON_PATH = os.path.join("data", "captioning_dataset_4imgs_test_40.json")
